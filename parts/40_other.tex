...
\begin{itemize}
    \item \textbf{\hyperref[paper:sparrta]{\bibentry{kargin2026sparrta}}}
    ...
    \item \textbf{\hyperref[paper:ai]{\bibentry{sroka2025ai}}}
...
The study confirms the potential of our model for microbial classification, but it also indicates the need for further optimisation and expansion of the training data set. In the future, this technology could support microbial diagnosis, reducing diagnostic time and improving the effectiveness of sepsis treatment due to its simplicity and accessibility. Part of the results presented in this publication was covered by a patent application at the European Patent Office EP24461637.1 "A computer implemented method for identifying a microorganism in a blood and a data processing system therefor".
    \item \textbf{\hyperref[paper:complung]{\bibentry{pardyl2023complung}}}
    ...
    \item \textbf{\hyperref[paper:propml]{\bibentry{struski2023propml}}}
    ...
    \item \textbf{\hyperref[paper:automating]{\bibentry{pardyl2022automating}}}
...
\begin{itemize}
    \item \textbf{National Science Center Preludium grant 2024-2025} ``Where to look next - guiding active visual exploration with
    internal model uncertainty''. Grant number: 2023/49/N/ST6/02465.
    \item \textbf{Foundation for Polish Science START scholarship 2026-2027} 
\end{itemize}

\subsection{As a participant / co-investigator}
\begin{itemize}
    \item \textbf{National Science Center Sonata grant 2024-2027} ``Sustainable computer vision for autonomous machines''. Grant number: 2023/50/E/ST6/00469.
    \item \textbf{Foundation for Polish Science Proof of Concept grant 2024-2025} ``Intelligent Fight Against Sepsis - Innovative Use of Artificial Intelligence in Rapid Microbiological Diagnosis of Sepsis''. Grant number: FENG.02.07-IP.05-0068/23.
    \item \textbf{European Commission Horizon Europe grant 2024-2027} ``European Lighthouse of AI for Sustainability (ELIAS)''. Grant number: 101120237.
    \item \textbf{Foundation for Polish Science Team-Net 2022-2023} ``Bio-inspired artificial neural networks''. Grant number: POIR.04.04.00-00-14DE/18-00.
\end{itemize}
