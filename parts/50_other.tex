...
\begin{itemize}[parsep=0pt,itemsep=0pt]
    ...
    \item {\raggedright \otherpubentry{sroka2025ai}\par}
...
\begin{itemize}
    \item \textbf{Reinforcement learning for visual exploration in real-world environments.} Adam Pardyl, Jan Mikołajczyk, Jan Matusiak, Hubert Zientata, Dominik Gaweł, Ignacy Alwasiak, Bartosz Zieliński, Marek Cygan, Maciej Wołczyk
    ...
    \item \textbf{Self-supervised concept discovery.} Adam Pardyl, Siddhartha Gairola, Sukrut Rao, Bernt Schiele, Bartosz Zieliński, Dawid Rymarczyk
