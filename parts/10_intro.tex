...
The main focus of this thesis is to enable machines to do the same: to \emph{learn to actively explore} their environment efficiently, perceiving only what they need in order to act on their goals.
...
captured, remains an open problem. The remainder of this chapter traces how the field arrived at this point, explains why general-purpose exploration is
...
Whether the same efficient, learned decision-making transfers to unconstrained, zero-shot, global-scale search remains largely an open question.
Finally, it is not clear whether methods designed for simplified simulation environments can be transferred to the real physical world, bridging the sim-to-real gap.
