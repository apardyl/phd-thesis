...
Their brittleness outside such controlled settings exposed how hard vision really is. Marr's influential computational theory of vision~\cite{marr1982vision} reframed the problem as one of recovering explicit representations of the world through successive stages of processing, and set an
