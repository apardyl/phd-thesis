...
\begin{figure}[th]
\centering
\input{figures/img/main/fig_cultural_aspirations.tex}
...
\begin{figure}[th]
\centering
\input{figures/img/main/fig_moravec.tex}
...
\begin{figure}[th]
\centering
\input{figures/img/main/fig_passive_active.tex}
...
\begin{figure}[th]
\centering
\input{figures/img/main/fig_technical_progress.tex}
...
\begin{figure}[t]
    \centering
    \input{figures/img/main/fig_local_global.tex}
...
\begin{enumerate}[label=\textbf{H\arabic*.},ref=H\arabic*]
    ...
    \item {\raggedright \label{hyp:flysearch} Current vision-language models can perform short-horizon visual navigation, but cannot reliably form and execute consistent multi-step search strategies in large, open, \mbox{three-dimensional environments}.\par}
\end{enumerate}

\begin{figure}[t]
\centering
\input{figures/img/main/fig_contributions.tex}
