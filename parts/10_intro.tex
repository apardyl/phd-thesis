...
Finally, they are \emph{scalable} toward the demands of real embodied agents operating in the open world, spanning both the local scale of choosing where to look and the global scale of choosing where to move, contrasted in Figure~\ref{fig:local-global}.
...
The first contribution, ``Active Visual Exploration Based on Attention-Map Entropy''~\pubcite{pardyl2023active}, asks how an agent should decide where to look
...
The second contribution, ``Beyond Grids: Exploring Elastic Input Sampling for Vision Transformers''~\pubcite{pardyl2023grids}, addresses that constraint.
...
The third contribution, ``AdaGlimpse: Active Visual Exploration with Arbitrary Glimpse Position and Scale''~\pubcite{pardyl2024adaglimpse}, closes the gap between
...
fourth contribution, ``FlySearch: Exploring how vision-language models explore''~\pubcite{pardyl2025flysearch}, turns to the complementary \emph{global-scale} problem: deciding where
