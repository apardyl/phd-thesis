...
\begin{figure}[t]
    ...
    \caption[The two scales of active exploration]{\textbf{The two scales of active exploration.} At the local scale, a sationary agent (e.g. a pan-tilt-zoom camera, or robot's head) remains at a fixed position and redirects its gaze towards different regions of the surrounding scene. At the global scale, a mobile agent (e.g. a robot or a UAV) relocates itself through three-dimensional space.}
