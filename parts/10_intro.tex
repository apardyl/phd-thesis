...
simulated by a computer algorithm~\cite{mccarthy1955proposal}.
...
advances share a quiet assumption: that the model is handed all needed visual information at once as a complete, static, sufficiently high-resolution image.
...
\begin{enumerate}[label=\textbf{H\arabic*.},ref=H\arabic*]
    ...
    \item \label{hyp:beyond} A vision transformer can be made resilient to input patches sampled at varying positions and scales or providing incomplete coverage, allowing it to process observations that do not follow a rigid grid.
