...
Figure~\ref{fig:beyond-elasticity} shows the three single-perturbation elasticity curves, comparing our ElasticViT against ViT, MAE, Swin-B, and PVT-v2-B5, all of comparable size and trained on ImageNet-1k.
