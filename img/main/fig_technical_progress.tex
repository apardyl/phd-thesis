...
\input{img/main/fig_history_geometry.tex}
...
\begin{scope}[shift={(3.9,-9.16)}]
  \node[inner sep=0pt] at (-0.87,0.52)
    {\includegraphics[width=1.30cm]{img/main/three/renders/contributions_scene.png}};
...
\begin{scope}[shift={(7.8,-9.16)}]
  \node[inner sep=0pt] at (-0.86,0.60)
    {\includegraphics[width=1.08cm]{img/main/three/renders/contributions_scene.png}};
