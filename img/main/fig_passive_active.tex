...
\node[imgnode] (fullscene) {\includegraphics[width=2.4cm]{img/main/three/renders/passive_active_camera.png}};
...
\node[imgnode, right=1.2cm of out1] (scene3p) {\includegraphics[width=3.1cm]{img/main/three/renders/passive_active_overview.png}};
\node[imgnode, right=0.55cm of scene3p, label=above:{\small camera view}] (scene1p) {\includegraphics[width=1.55cm]{img/main/three/renders/passive_active_camera.png}};
...
\node[captiontext, text width=7.2cm, below=0.15cm of righttitle] (rightcap) {the agent acts to decide what to observe next};
...
\node[fill=black!45, inner sep=0pt, minimum width=0.4pt, minimum height=5.5cm, anchor=north,
      right=0.6cm of leftgroup.east, yshift=-.5cm] {};
