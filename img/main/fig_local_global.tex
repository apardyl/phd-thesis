...
\node[imgnode] (ptz) {\includegraphics[width=6.6cm]{img/main/three/renders/two_scales_ptz.png}};
...
\node[imgnode, right=2.6cm of ptz] (uav) {\includegraphics[width=6.6cm]{img/main/three/renders/two_scales_uav.png}};
