...
\node[imgnode] (chess) {\includegraphics[width=6.6cm]{figures/img/main/three/renders/moravec_chess.png}};
\node[imgnode, right=2.0cm of chess] (crowd) {\includegraphics[width=6.6cm]{figures/img/main/three/renders/moravec_crowd.png}};
...
\node[imgnode, anchor=north west] (portrait) at ($(crowd.north west)+(0.14,-0.14)$)
  {\includegraphics[width=1.05cm]{figures/img/main/three/renders/moravec_portrait.png}};
