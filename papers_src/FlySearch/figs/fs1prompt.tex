\begin{lstlisting}[caption=Prompt template for \challenge{} and \anomalychallenge{}.,label={lst:promptfs1}]
<Context>
...
<Controls>
    <Action space>
        ...
        <Action>(x, y, z)</Action>. For example, if you want to fly to the place denoted as (10, 10) on the grid without changing the altitude, you should reply with <Action>(10, 10, 0)</Action>.
